# 8) Na matriz de 20x20 abaixo, quatro números ao longo de uma linha diagonal foram marcadas em negrito. 
...
def maior_produto_na_grade(matriz):

    linhas = len(matriz)
    colunas = len(matriz[0])
    maior_produto = 0

    # Verifique horizontalmente
...
resultado = maior_produto_na_grade(matriz)

print("O maior produto de quatro números adjacentes na matriz é:", resultado)
